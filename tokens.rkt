...
(token: directive ([name : String] [value : (Option (Pair Integer Integer))]))
...
(token: tag ([value : (Pair (Option String) (Option String))]))
(token: scalar ([value : String] [plain : Boolean] [style : Char]))
